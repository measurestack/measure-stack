...
module.exports = async function handleEvent(context) {
    req = context.req;
    // First extract tracking data from JSON, form, and query params
    ...
    // Capture Metadata (Time, User IP Adress)
    ...
    trackingData.c = trackingData.c || getCookie(context, process.env.CLIENT_ID_COOKIE_NAME);
